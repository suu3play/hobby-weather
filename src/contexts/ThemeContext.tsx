...
import type { ThemeContextType, ThemeConfig, Theme, ThemeMode } from '../types/theme';
import {
  getSystemPreference,
  loadThemeConfig,
  saveThemeConfig,
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribeReducedMotion = createMediaQueryListener(
      (matches) => {
        setConfig(prev => {
    ...
    const unsubscribeHighContrast = createMediaQueryListener(
      (matches) => {
        setConfig(prev => {
